...
valores_malos = [0.09, 0.000,-1,0.000,1.751,0.005,3.085,5.675,5.373,9.686,15.596,5.865,28.909,-1,10.313,18.786,15.699,22.216,20.04,23.824,31.848,-1,7.876,-1,28.034,30.943,25.021,18.903,36.25,0]


valores_buenos = [0.09,0.000,0.000,0.000,0.482,0.003,3.085,4.323,5.373,9.686,10.349,3.721,12.417,6.549,10.313,18.786,14.171,17.897,19.603,23.566,24.175,31.135,3.822,29.902,24.775,30.748,25.021,14.683,29.999,0]



for i in range(1, 31):
    crear_archivo_dzn(f'C:/Users/braya/Desktop/PROYECOTS/ProyectoGUI-Fuentes/DatosProyecto/MinPol{i}.mpl')
    print(f"\n\nresolviendo: {i}......")
